...
# A operações no hadoop são limitadas, em geral imutável, sendo necessário substituir a nova
# coleção de dados. Para este projeto criaremos uma tabela temporária para receber os valores
# que não sofrerão alteração, em seguida atribuímos o valor da tabela temporária para a
# dimensão que vai sofrer a alteração.

spark_session.sql(
    "CREATE TABLE adventureworks.temp_culture "
